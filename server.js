...
const collectors = [
  ...
  collectTokaiIbEvents, collectKogaIbEvents, collectTsukubaEvents, collectRyugasakiEvents,
  collectTorideEvents, collectMitoEvents, collectKashimaIbEvents, collectKasamaEvents,
  collectChikuseiEvents, collectTsuchiuraEvents, collectIshiokaEvents, collectJosoEvents,
  collectNakaIbEvents, collectBandoEvents, collectHitachiotaEvents, collectYukiEvents,
  collectTsukubamiraiEvents, collectInashikiEvents, collectSakuragawaEvents, collectHitachiomiyaEvents,
  collectShimotsumaEvents, collectHokotaEvents, collectNamegataEvents, collectItakoEvents,
  collectKasumigauraEvents, collectTakahagiEvents, collectShiroIbEvents, collectSakaiIbEvents, collectDaigoEvents,
  ...
  // 東北6県
  collectAomoriAomoriEvents, collectHachinoheEvents, collectTsugaruEvents, collectHiranaiEvents, collectNakadomariEvents, collectYomogitaEvents, collectItayanagiEvents,
  collectIchinosekiEvents, collectIwateMoriokaEvents, collectKitakamiEvents, collectKujiEvents, collectOshuEvents, collectNishiwagaEvents, collectIchinoheEvents, collectOtsuchiEvents,

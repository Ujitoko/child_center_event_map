...
// 岩手県
const collectIwateMoriokaEvents = createEventJsCollector({ source: IWATE_MORIOKA_SOURCE, jsFile: "event_data.js", childCategoryIds: [], useKeywordFilter: true }, eventJsDeps);
...
const collectAichiKomakiEvents = createCalendarJsonCollector({ source: AICHI_KOMAKI_SOURCE, childKeywords: CHUBU_CHILD_KW, useKeywordFilter: true }, geoFmDeps);
const collectAichiNagoyaEvents = createEventJsCollector({ source: AICHI_NAGOYA_SOURCE, jsFile: "event.js", childCategoryIds: ["60"], useKeywordFilter: true }, eventJsDeps);
const collectAichiToyotaEvents = createEventJsCollector({ source: AICHI_TOYOTA_SOURCE, jsFile: "event_d.js", childCategoryIds: ["10"], useKeywordFilter: true }, eventJsDeps);
const collectAichiKasugaiEvents = createEventJsCollector({ source: AICHI_KASUGAI_SOURCE, jsFile: "event.js", childCategoryIds: ["5"], useKeywordFilter: true }, eventJsDeps);
const collectAichiIchinomiyaEvents = createEventJsCollector({ source: AICHI_ICHINOMIYA_SOURCE, jsFile: "event_data.js", childCategoryIds: ["6"], useKeywordFilter: true }, eventJsDeps);
const collectGifuGifuEvents = createEventJsCollector({ source: GIFU_GIFU_SOURCE, jsFile: "event.js", childCategoryIds: ["60"], useKeywordFilter: true }, eventJsDeps);
...
// 三重県
const collectMieTsuEvents = createEventJsCollector({ source: MIE_TSU_SOURCE, jsFile: "event.js", childCategoryIds: ["40"], useKeywordFilter: true }, eventJsDeps);
...
// 和歌山県
const collectWakayamaWakayamaEvents = createEventJsCollector({ source: WAKAYAMA_WAKAYAMA_SOURCE, jsFile: "event_d.js", childCategoryIds: ["4"], useKeywordFilter: true }, eventJsDeps);
...
const collectOkinawaNahaEvents = createEventJsCollector({ source: OKINAWA_NAHA_SOURCE, jsFile: "event.js", childCategoryIds: ["50"], useKeywordFilter: true }, eventJsDeps);
// 追加ママフレ都市
...
const getEvents = createGetEvents({
  ...
  collectIwateMoriokaEvents, collectKitakamiEvents, collectKujiEvents, collectOshuEvents, collectNishiwagaEvents, collectIchinoheEvents, collectOtsuchiEvents,

...
function detectPrefecture(cityLabel, sourceKey) {
  ...
  if (/^(秋田市|能代市|横手市|大館市|男鹿市|湯沢市|鹿角市|由利本荘市|潟上市|大仙市|北秋田市|にかほ市|仙北市)/.test(cityLabel)) return "秋田県";
  if (/^(山形市|米沢市|鶴岡市|酒田市|新庄市|寒河江市|上山市|村山市|長井市|天童市|東根市|尾花沢市|南陽市)/.test(cityLabel)) return "山形県";
  if (/^(福島市|会津若松市|郡山市|いわき市|白河市|須賀川市|喜多方市|相馬市|二本松市|田村市|南相馬市|伊達市|本宮市)/.test(cityLabel)) return "福島県";
  return "東京都";
}

...
function createGetEvents(deps) {
  ...
  const allCollectorResults = await batchCollect([
    ...
    () => collectIwateMoriokaEvents(days),
    ...
    () => collectWakayamaWakayamaEvents(days),
